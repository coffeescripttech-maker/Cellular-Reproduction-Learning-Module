      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-5">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="lastName" className="text-gray-900 font-semibold text-sm flex items-center space-x-2">
                <span>Last Name *</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Grade Level - select */}
            <div className="space-y-2">
              <Label htmlFor="gradeLevel" className="text-gray-900 font-semibold text-sm">Grade Level</Label>
              <select
                id="gradeLevel"
          ...
          <div className="space-y-2">
            <Label htmlFor="learningStyle" className="text-gray-900 font-semibold text-sm">Learning Style</Label>
            <select
              id="learningStyle"
              className="w-full h-11 px-3 py-2 !border-2 !border-gray-200 focus:!border-[#00af8f] focus:ring-4 focus:ring-[#00af8f]/10 rounded-xl transition-all duration-300 hover:!border-[#00af8f]/50 hover:shadow-md"
          ...
          <div className="space-y-2">
            <Label htmlFor="learningType" className="text-gray-900 font-semibold text-sm flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2 p-4 bg-blue-50 border border-blue-200 rounded-xl">
            ...
            />
            <Label htmlFor="bypassOnboarding" className="text-sm text-gray-700 cursor-pointer">
